...
const AktDocument = ({ data = {}, onClose }) => {
  ...
  // Helper function to extract numeric amount from string like "10 RUB"
  ...
  const [formData, setFormData] = useState({
    ...
    akt_number: data?.akt_number || `AKT-${data?.agreement_number || "N/A"}`,
          ...
          <div className="akt-content" ref={aktRef}>
            <div className="container">
              ...
              >
                ...
                от {formatDateDDMMYYYY(formData.payment_date) || ""}{" "}
                {formatDateToRussianMonth(formData.link_created_at) || ""} г.
              </p>
                    ...
                    <tr>
                      ...
                      <td>
                        <b>
                          ...
                          {formatDateToRussianMonth(
                            formData.appointment_created_at
                          ) || "N/A"}
                        </b>
                      </td>
                    </tr>
