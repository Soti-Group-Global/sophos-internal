  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      try {
        ...
        await addAssistant(formDataToSend);
    ...
    <div className="modern-form-container">
      <div className="modern-form-card">
        ...
        <div className="form-section">
          <h2 className="form-title">{t("add_assistant_title")}</h2>
          ...
          <form onSubmit={handleSubmit} className="modern-form">
            <div className="form-row">
              <div className="form-field">
                <label>
                  {t("first_name")} <span className="required-asterisk">*</span>
                </label>
                <input
                  type="text"
                  name="firstName"
              ...
              <div className="form-field">
                <label>
                  {t("last_name")} <span className="required-asterisk">*</span>
                </label>
                <input
                  type="text"
                  name="lastName"
            ...
            <div className="form-row">
              <div className="form-field">
                <label>
                  {t("gender")} <span className="required-asterisk">*</span>
                </label>
                <Select
