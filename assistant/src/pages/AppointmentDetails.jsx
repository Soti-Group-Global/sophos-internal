...
const AppointmentDetails = () => {
  ...
  const { doctorName } = locationState.state || {};
  ...
  const fetchAppointment = async () => {
    try {
      ...
      // Prevent access if appointment date is in the future (ignore time)
      ...
      if (appointmentDateOnly > todayDateOnly) {
        toast.warning("You cannot access details of a future appointment.");
  ...
  const handleSavePrescription = async () => {
    try {
      ...
      toast.success(t("Precription Saved"));
      setAppointment(updatedAppointment);
      ...
      <div className="details-grid">
        ...
        <div className="detail-item">
          {appointmentMode?.toLowerCase() === "online" ? (
            <FiVideo className="appointment-detail-icon" />
          ) : (
            <FiActivity className="appointment-detail-icon" />
          )}
          <div>
        ...
        {doctor && (
          <div className="detail-item">
            ...
            <div>
              ...
              <p className="detail-value">
                {(typeof doctorName === 'object' ? doctorName?.[lang] || doctorName?.en : doctorName) || "Not specified"}
              </p>
            </div>
          </div>
        )}
        ...
        {location && (
          <div className="detail-item">
            <FiMapPin className="appointment-detail-icon" />
            <div>
                    ...
                    {doc.verificationStatus && (
                      ...
                      >
                        ...
                        {doc.verificationStatus === "Under Review" && (
                          <>
                            <FiClock className="status-icon review" />
                            Under Review
                          </>
                        )}
